...
export const ContactPage = () => {
    ...
    return (
        <div className="overflow-hidden">
            {/* Hero Section */}
            <section className="relative min-h-[50vh] lg:min-h-[60vh] flex items-center bg-hero-pattern px-4 lg:px-8 pt-24">
                <div className="container mx-auto">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="font-display text-5xl lg:text-7xl text-primary-foreground leading-tight mb-6 animate-fade-in animation-delay-100">
                            GET IN
                            <span className="text-gradient-gold block">TOUCH</span>
                        </h1>
